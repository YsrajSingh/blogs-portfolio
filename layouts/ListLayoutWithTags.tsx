  ...
  return (
    <>
      <div className="mx-auto w-full max-w-6xl px-4 pb-8 md:pb-12">
        <h1 className="text-4xl leading-10 font-extrabold tracking-tight text-gray-900 sm:hidden sm:text-5xl sm:leading-12 md:text-7xl md:leading-16 dark:text-gray-100">
          {title}
        </h1>
        <div className="flex sm:space-x-24">
          <div className="hidden h-full max-h-screen max-w-[280px] min-w-[280px] flex-wrap overflow-auto rounded-lg bg-gray-50 pt-6 sm:flex dark:bg-gray-900/70">
              ...
              {displayPosts.map((post) => {
                ...
                return (
                  <li key={path} className="py-8">
                    <article className="flex flex-col space-y-4 xl:space-y-0">
                      <dl>
